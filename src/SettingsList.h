  ...
  static const std::vector<SettingInfo> baseList = [] {
    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::EnumStrings(
            ...
            {"1 стр.", "5 стр.", "10 стр.", "15 стр.", "20 стр.", "Глава", "30 стр."},
            "refreshFrequency", StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_UI_THEME, &CrossPointSettings::uiTheme,
                          {StrId::STR_THEME_CLASSIC, StrId::STR_THEME_LYRA, StrId::STR_THEME_CAROUSEL,
                           StrId::STR_THEME_ROUNDEDRAFF, StrId::STR_THEME_MINIMAL, StrId::STR_THEME_DASHBOARD,
                           StrId::STR_THEME_STUDIO},
        ...
        SettingInfo::Toggle(StrId::STR_SHOW_HIDDEN_FILES, &CrossPointSettings::showHiddenFiles, "showHiddenFiles",
                            StrId::STR_CAT_SYSTEM),
        SettingInfo::Enum(StrId::STR_FILE_SORT_BY, &CrossPointSettings::fileSortMode,
                          {StrId::STR_SORT_BY_NAME, StrId::STR_SORT_BY_DATE, StrId::STR_SORT_BY_SIZE},
                          "fileSortMode", StrId::STR_CAT_SYSTEM),
        SettingInfo::Enum(StrId::STR_FILE_SORT_DIR, &CrossPointSettings::fileSortDirection,
                          {StrId::STR_SORT_ASCENDING, StrId::STR_SORT_DESCENDING},
                          "fileSortDirection", StrId::STR_CAT_SYSTEM),
        ...
        SettingInfo::Enum(StrId::STR_CHAPTER_PAGE_COUNT, &CrossPointSettings::statusBarChapterPageCount,
